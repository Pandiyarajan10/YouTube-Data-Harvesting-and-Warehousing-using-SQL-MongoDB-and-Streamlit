api_key='AIzaSyABJW3R8z-VlmHYPkW6JiEPpLkDrPNGKvs'
...
Pandy_DB=pymongo.MongoClient("mongodb+srv://Pandiyarajan:Pandy1010@pandiyarajan.db0kwvv.mongodb.net/?retryWrites=true&w=majority") #copy the link from mongodb altas to establish connection and enter your password

db=Pandy_DB["Youtube_Project"]
col=db["Channels"]
